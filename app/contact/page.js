        ...
        <div className="lg:col-span-1 space-y-6">
          {contactInfo.map((info, i) => (
            <div key={i} className="bg-[#f2f0f4] dark:bg-[#1b1b1f] p-8 rounded-[2.5rem] border border-transparent hover:border-rail-accent/20 transition-all group">
              ...
              <p className="text-[10px] text-[#74777f] uppercase font-bold tracking-widest italic">{info.sub}</p>
            </div>
          ))}
        </div>
        ...
        <div className="lg:col-span-2 bg-[#f2f0f4] dark:bg-[#1b1b1f] p-10 md:p-16 rounded-[3.5rem] shadow-sm">
          {!sent ? (
            <form onSubmit={(e) => { e.preventDefault(); setSent(true); }} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-[10px] font-black uppercase tracking-widest ml-4 text-[#74777f]">Full Name</label>
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-black uppercase tracking-widest ml-4 text-[#74777f]">Email Address</label>
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-widest ml-4 text-[#74777f]">Message</label>
            ...
            <div className="text-center py-20 animate-fade-in">
              ...
              <p className="text-sm text-[#74777f] font-medium italic">We'll get back to your signal soon.</p>
